...
module.exports = async function (req, res) {
    ...
    ////////////***************************************************************************           Resources */
    let woodTypeID = bodyjson.woodTypeID;
    console.log("Wood ID = " + woodTypeID);
    let rockTypeID = bodyjson.rockTypeID;
    console.log("Rock ID = " + rockTypeID);
    let goldTypeID = bodyjson.goldTypeID;
    console.log("Gold ID = " + goldTypeID);
    let diamondTypeID = bodyjson.diamondTypeID;
    console.log("Diamond ID = " + diamondTypeID);
    let siliconTypeID = bodyjson.siliconTypeID;
    console.log("Silicon ID = " + siliconTypeID);
    let ironTypeID = bodyjson.ironTypeID;
